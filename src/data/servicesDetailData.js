...
export const SERVICES_DETAIL_DATA = [
  {
    ...
    cardTitle: 'Plan de marketing',
    pageTitle: 'Plan de Marketing',
    cardDesc: 'Creamos estrategias personalizadas para impulsar tu negocio, definiendo objetivos claros.',
    pageDesc:
  ...
  },
  {
    ...
    cardTitle: 'Planificación en medios digitales',
    pageTitle: 'Planificación y asesoramiento en medios digitales',
    cardDesc: 'Te guiamos en el uso eficiente de plataformas digitales.',
    pageDesc:
  ...
  },
  {
    ...
    cardTitle: 'Planificación en medios tradicionales',
    pageTitle: 'Planificación y asesoramiento en medios tradicionales',
    cardDesc: 'Potenciamos tu presencia en radio, televisión y prensa gráfica.',
    pageDesc:
  ...
  },
  {
    ...
    cardTitle: 'Investigación y análisis de la competencia',
    pageTitle: 'Investigación y análisis de la competencia',
    cardDesc: 'Estudios detallados del mercado para identificar oportunidades.',
    pageDesc:
  ...
  {
    slug: 'asesoria-eventos',
    cardTitle: 'Asesoría en eventos y comunicadores de marca',
    pageTitle: 'Asesoría en eventos & Comunicadores de marca',
    cardDesc: 'Planificación de eventos y acciones que posicionen tu marca.',
    pageDesc:
  ...
  },
  {
    ...
    pageTitle: 'Diseño web',
    cardDesc: 'Sitios web funcionales y atractivos que convierten visitas en resultados.',
    pageDesc:
      'Desarrollamos sitios web funcionales y atractivos que se adaptan a las necesidades de tu negocio.',
    intro: 'Nos enfocamos en brindar:',
    bullets: [
